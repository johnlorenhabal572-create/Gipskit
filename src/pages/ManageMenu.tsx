                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex gap-2">
                      <button 
                        ...
                        className={`flex-1 py-2 rounded-xl text-xs font-bold border transition-all ${formData.status === 'Available' ? 'bg-green-50 border-green-200 text-green-600 shadow-sm' : 'bg-white border-gray-200 text-gray-400'}`}
                      >
                        Available
                      </button>
                      <button 
                        ...
                        className={`flex-1 py-2 rounded-xl text-xs font-bold border transition-all ${formData.status === 'Not Available' ? 'bg-red-50 border-red-200 text-red-600 shadow-sm' : 'bg-white border-gray-200 text-gray-400'}`}
                      >
                        Not Available
                      </button>
                    </div>
